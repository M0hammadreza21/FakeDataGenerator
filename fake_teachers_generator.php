<?php
    ...
    $teacher_fullname = $firstNameMale[$male_Firstname] .' '.$lastName[$generated_lastName];
    $teacher_mobileNumber = '0919' .rand(100,900).''.rand(0000,9999);
    $teacher_nationalCode = '197' .rand(200,500).''.rand(600,700).''.rand(1,9);
    $teacher_password = rand(102030,908070);
...
require_once "../config.php";
        ...
        $stmt = $pdo->prepare("INSERT INTO teachers (teacher_fullname, teacher_nationalCode, teacher_password, teacher_mobileNumber) VALUES (?,?,?,?)"); 
        if($stmt->execute([ $teacher_fullname, $teacher_nationalCode, $teacher_password, $teacher_mobileNumber ])) {
                $stmt = null;
